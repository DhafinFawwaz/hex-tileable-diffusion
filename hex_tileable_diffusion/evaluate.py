...
def evaluate_hex_tileable_diffusion_texture(input: ImageInput, output: ImageInput, wrapper_config: HexWrapperConfig, metrics: Metrics | None = None, observer: HexObserver | None = None) -> HexEvaluation:
